...
export default function Newsletter() {
    ...
    return (
        <section style={{
            ...
            <h2 style={{ fontSize: 'clamp(1.1rem, 3.5vw, 2.25rem)', lineHeight: 1.2, margin: 0 }}>
                suscríbete a nuestro newsletter<br />
                para enterarte de todo
            </h2>

            <div className="flex items-end mt-8 w-full" style={{ maxWidth: '600px' }}>
                <div className="flex flex-col w-full">
                    <div className="flex flex-row justify-between items-baseline w-full">
                        <input
                            ...
                            className="text-white placeholder:text-white bg-transparent p-0 outline-none flex-1 min-w-0"
                        />
                        <button
                            onClick={handleSubmit}
                            disabled={status === 'loading'}
                            className="ml-3 mb-1 shrink-0 hover:opacity-70 transition-opacity disabled:opacity-40"
                        >
                    ...
                    {/* underline — stretches to full width */}
                    <svg
                        viewBox="0 0 736 9"
